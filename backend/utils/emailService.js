  ...
  return sendMail({
    ...
    html: `
      <div style="margin:0;padding:0;background:#f4f6f8;font-family:Arial,sans-serif;">
        ...
        <div style="max-width:640px;margin:40px auto;background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #e5e7eb;">
          ...
          <div style="padding:20px;text-align:center;background:#fcfcfd;border-top:1px solid #e5e7eb;color:#667085;font-size:12px;">
            © Svet Igraonica
          </div>
